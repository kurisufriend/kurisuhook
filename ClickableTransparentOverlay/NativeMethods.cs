...
namespace ClickableTransparentOverlay
{
    ...
    public static class NativeMethods
    {
        ...
        internal static void SetOverlayClickable(IntPtr handle, bool WantClickable)
        {
            ...
            {
                SetWindowLong32(handle, GWL_EXSTYLE, GWL_EXSTYLE_CLICKABLE);
                SetFocus(handle);
                isClickable = true;
            }
            else if(isClickable && !WantClickable)
            {
                SetWindowLong32(handle, GWL_EXSTYLE, GWL_EXSTYLE_NOT_CLICKABLE);
                isClickable = false;
            }
        }
        ...
        /// For keycode information visit: https://www.pinvoke.net/default.aspx/user32.getkeystate nope is getasynckeystate
        /// </summary>
        ...
        {
            return Convert.ToBoolean(GetAsyncKeyState(nVirtKey) & KEY_PRESSED);
        }
        /// <summary>
        /// Returns true if the key is BOOPED.
        /// For keycode information visit: https://www.pinvoke.net/default.aspx/user32.getkeystate nope is getasynckeystate
        /// </summary>
        /// <param name="nVirtKey">key to look for.</param>
        /// <returns>weather the key is pressed or not.</returns>
        ...
        public static bool IsKeyPressedBetter(int nVirtKey)
        {
            return Convert.ToBoolean(GetAsyncKeyState(nVirtKey) & 0xFFF);
        }
        /// <summary>
        /// what retard thought it was a good idea to use the other one
        /// </summary>
